 ...
 */
final class Version20221119104111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, date_start DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', date_end DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', date_place DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', status ENUM(\'draft\', \'requested\', \'accepted\', \'rejected\', \'confirmed\', \'cancelled\', \'debriefing\', \'finished\') NOT NULL COMMENT \'(DC2Type:serviceStatus)\', created_at DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', updated_at DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE speciality (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) NOT NULL, created_at DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', updated_at DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_speciality (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', speciality_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', date_start DATE NOT NULL, date_end DATE DEFAULT NULL, created_at DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', updated_at DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', INDEX IDX_54B066623B5A08D7 (speciality_id), INDEX IDX_54B06662A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, date_start DATE NOT NULL, date_end DATE DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', created_at DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', updated_at DATETIME(6) NOT NULL COMMENT \'(DC2Type:carbon)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
